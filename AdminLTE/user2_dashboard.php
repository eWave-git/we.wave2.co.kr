<?php
    $sql1 = "select * from mush.raw_data where address = 401 and board_number=2 order by create_at desc limit 1";
    $result1 = mysqli_query($conn, $sql1);
    $row1 = mysqli_fetch_array($result1);

    $sql2 = "select * from mush.raw_data where address = 401 and board_number=3 order by create_at desc limit 1";
                ...
                <div class="card card-primary card-tabs">
                    <div class="card-header p-0 pt-1">
                        <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="custom-tabs-two-home-tab" data-toggle="pill" href="#custom-tabs-two-home" role="tab" aria-controls="custom-tabs-two-home" aria-selected="true">표고버섯</a>
                            </li>
...
<script>
    $(function () {
        ...
        function Get_Line_Chart_3_Data() {
            $.ajaxSetup({ cache: false });
            $.ajax({
                url: "../conf/user2_Ajax_Line_Chart_3.data.php",
                dataType: 'json',
                success: function (data) {
        ...
        function Get_Line_Chart_4_Data() {
            $.ajaxSetup({ cache: false });
            $.ajax({
                url: "../conf/user2_Ajax_Line_Chart_4.data.php",
                dataType: 'json',
                success: function (data) {
